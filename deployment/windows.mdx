---
title: "Run Odysseus Natively on Windows"
sidebarTitle: "Windows"
description: "Deploy Odysseus on Windows using the one-command PowerShell launcher or a manual Python virtual environment setup."
---
