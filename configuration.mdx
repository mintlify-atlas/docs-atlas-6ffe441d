...
| `FASTEMBED_CACHE_PATH` | `~/.cache/fastembed` | Local cache directory for fastembed model files. Defaults to the fastembed library default. Override to store model files on a specific volume. |
