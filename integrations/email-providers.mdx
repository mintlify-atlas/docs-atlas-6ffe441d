---
title: "Add Email Accounts to Odysseus via IMAP and SMTP"
sidebarTitle: "Email Providers"
description: "Odysseus email uses standard IMAP/SMTP with username and password. Works with Gmail app passwords, Fastmail, ProtonMail Bridge, and most IMAP-enabled providers."
---
...
<Warning>
  ...
  This is a Microsoft policy, not a configuration error. OAuth and Microsoft Graph Mail integration is not yet available in Odysseus, so most Outlook and Microsoft 365 accounts cannot currently be added through the IMAP/SMTP form. Use a different provider, or check whether your specific tenant still permits app passwords for IMAP access.
</Warning>
